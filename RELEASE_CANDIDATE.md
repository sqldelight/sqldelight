...
buildscript {
  ...
  dependencies {
    classpath 'com.squareup.sqldelight:gradle-plugin:1.0.0-rc5'
  }
}
...
needed to execute any of your labeled queries. Download the [IntelliJ plugin rc5](https://plugins.jetbrains.com/plugin/8191-sqldelight)
...
```groovy
dependencies {
  implementation 'com.squareup.sqldelight:android-driver:1.0.0-rc5'
}
```
...
```groovy
dependencies {
  implementation 'com.squareup.sqldelight:rxjava2-extensions:1.0.0-rc5'
}
```
...
Upgrade the gradle plugin from 0.9 to 1.0.0-rc5. Note your build will fail at this point because of
