...
object FixtureCompiler {
  ...
  fun compileFixture(
    ...
    if (generateDb) {
      SqlDelightCompiler.writeDatabaseInterface(environment.module, file!!, fileWriter)
      SqlDelightCompiler.writeImplementations(environment.module, file!!, fileWriter)
    }
