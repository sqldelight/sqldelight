...
private suspend fun PagingSource<Int, TestItem>.refresh(key: Int? = null): PagingSource.LoadResult<Int, TestItem> = load(createLoadParam(LoadType.REFRESH, key))

private suspend fun PagingSource<Int, TestItem>.append(key: Int?): PagingSource.LoadResult<Int, TestItem> = load(createLoadParam(LoadType.APPEND, key))

private suspend fun PagingSource<Int, TestItem>.prepend(key: Int?): PagingSource.LoadResult<Int, TestItem> = load(createLoadParam(LoadType.PREPEND, key))
