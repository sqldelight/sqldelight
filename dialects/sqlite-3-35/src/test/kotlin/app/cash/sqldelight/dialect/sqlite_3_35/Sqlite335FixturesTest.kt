...
class Sqlite335FixturesTest(name: String, fixtureRoot: File) : FixturesTest(name, fixtureRoot) {
  ...
  companion object {
    private val fixtures = arrayOf(/*"src/test/fixtures_sqlite_3_18", "src/test/fixtures_sqlite_3_24",*/ "../sqlite-3-25/src/test/fixtures_sqlite_3_25", "../sqlite-3-30/src/test/fixtures_sqlite_3_30", "src/test/fixtures_sqlite_3_35")
