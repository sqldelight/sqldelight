...
ALTER TABLE t1
    ...
    ALTER c6 TYPE TIMESTAMPTZ USING c6::TIMESTAMPTZ,
    ALTER c7 TYPE TIMESTAMPTZ USING c7 AT TIME ZONE 'UTC',
    ALTER c8 TYPE TEXT USING 'A' || 'B' || 'C',
    ALTER COLUMN c9 TYPE TEXT USING replace(c9, 'foo', 'bar');
