  ...
  override fun squish(
    ...
    return when {
      ...
      statement.dropIndexStmt != null && statement.dropIndexStmt?.indexName != null -> {
        ...
        } ?: throw Exception("Create statement not found for drop index statement ${statement.dropIndexStmt?.indexName?.text}")
      ...
      statement.dropTableStmt != null && statement.dropTableStmt?.tableName != null -> {
        ...
        } ?: throw Exception("Create statement not found for drop table statement ${statement.dropTableStmt?.tableName?.text}")
      ...
      statement.dropTriggerStmt != null && statement.dropTriggerStmt?.triggerName != null -> {
        ...
        } ?: throw Exception("Create statement not found for drop trigger statement ${statement.dropTriggerStmt?.triggerName?.text}")
        currentFile.text.replaceRange(create.startOffset..create.endOffset, "")
      }
      statement.dropViewStmt != null  && statement.dropViewStmt?.viewName != null -> {
        ...
        } ?: throw Exception("Create statement not found for drop view statement ${statement.dropViewStmt?.viewName?.text}")
        currentFile.text.replaceRange(create.startOffset..create.endOffset, "")
      }
      else -> {
