...
internal val TestDialect.textType
  get() = when (this) {
    MYSQL, SQLITE_3_24, SQLITE_3_18, SQLITE_3_25, SQLITE_3_30, SQLITE_3_35, SQLITE_3_38, SQLITE_3_44, POSTGRESQL -> "TEXT"
    HSQL -> "VARCHAR(8)"
  }

internal val TestDialect.blobType
  get() = when (this) {
    MYSQL, SQLITE_3_24, SQLITE_3_18, SQLITE_3_25, SQLITE_3_30, SQLITE_3_35, SQLITE_3_38, SQLITE_3_44, HSQL -> "BLOB"
    POSTGRESQL -> "BYTEA"
  }

internal val TestDialect.intType
  get() = when (this) {
    MYSQL, SQLITE_3_24, SQLITE_3_18, SQLITE_3_25, SQLITE_3_30, SQLITE_3_35, SQLITE_3_38, SQLITE_3_44, POSTGRESQL, HSQL -> "INTEGER"
  }

internal val TestDialect.intKotlinType
  get() = when (this) {
    SQLITE_3_24, SQLITE_3_18, SQLITE_3_25, SQLITE_3_30, SQLITE_3_35, SQLITE_3_38, SQLITE_3_44 -> LONG
