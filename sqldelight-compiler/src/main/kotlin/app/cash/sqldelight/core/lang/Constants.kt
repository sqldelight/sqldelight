...
internal val ASYNC_DRIVER_TYPE = ClassName("app.cash.sqldelight.db", "AsyncSqlDriver")
...
internal val ASYNC_QUERY_TYPE = ClassName("app.cash.sqldelight", "AsyncQuery")
internal val EXECUTABLE_QUERY_TYPE = ClassName("app.cash.sqldelight", "ExecutableQuery")
internal val ASYNC_EXECUTABLE_QUERY_TYPE = ClassName("app.cash.sqldelight", "AsyncExecutableQuery")
...
internal val ASYNC_TRANSACTER_TYPE = ClassName("app.cash.sqldelight", "AsyncTransacter")
internal val ASYNC_TRANSACTER_IMPL_TYPE = ClassName("app.cash.sqldelight", "AsyncTransacterImpl")
